...
This notebook executes a high-dimensional data analysis on the Water Treatment Plant
dataset. The objective is to compute the eigenvalues of the sample covariance matrix, fit the
Marčenko-Pastur density to find the empirical noise edge, and project the data onto
principal coordinates to analyze outliers
#
